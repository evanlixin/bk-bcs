...
func (watch *ServiceWatch) AddEvent(obj interface{}) {
	...
	if err := watch.report.ReportData(data); err != nil {
		util.ReportSyncTotal(cluster.DataTypeSvr, types.ActionAdd, cluster.SyncFailure)
	} else {
		util.ReportSyncTotal(cluster.DataTypeSvr, types.ActionAdd, cluster.SyncSuccess)
	}
}
...
func (watch *ServiceWatch) DeleteEvent(obj interface{}) {
	...
	if err := watch.report.ReportData(data); err != nil {
		util.ReportSyncTotal(cluster.DataTypeSvr, types.ActionDelete, cluster.SyncFailure)
	} else {
		util.ReportSyncTotal(cluster.DataTypeSvr, types.ActionDelete, cluster.SyncSuccess)
	}
}
...
func (watch *ServiceWatch) UpdateEvent(old, cur interface{}) {
	...
	if err := watch.report.ReportData(data); err != nil {
		util.ReportSyncTotal(cluster.DataTypeSvr, types.ActionUpdate, cluster.SyncFailure)
	} else {
		util.ReportSyncTotal(cluster.DataTypeSvr, types.ActionUpdate, cluster.SyncSuccess)
	}
}
