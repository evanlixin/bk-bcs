...
func (watch *DeploymentWatch) AddEvent(obj interface{}) {
	...
	if err := watch.report.ReportData(data); err != nil {
		util.ReportSyncTotal(cluster.DataTypeDeploy, types.ActionAdd, cluster.SyncFailure)
	} else {
		util.ReportSyncTotal(cluster.DataTypeDeploy, types.ActionAdd, cluster.SyncSuccess)
	}
}
...
func (watch *DeploymentWatch) DeleteEvent(obj interface{}) {
	...
	if err := watch.report.ReportData(data); err != nil {
		util.ReportSyncTotal(cluster.DataTypeDeploy, types.ActionDelete, cluster.SyncFailure)
	} else {
		util.ReportSyncTotal(cluster.DataTypeDeploy, types.ActionDelete, cluster.SyncSuccess)
	}
}
...
func (watch *DeploymentWatch) UpdateEvent(old, cur interface{}) {
	...
	if err := watch.report.ReportData(data); err != nil {
		util.ReportSyncTotal(cluster.DataTypeDeploy, types.ActionUpdate, cluster.SyncFailure)
	} else {
		util.ReportSyncTotal(cluster.DataTypeDeploy, types.ActionUpdate, cluster.SyncSuccess)
	}
}
