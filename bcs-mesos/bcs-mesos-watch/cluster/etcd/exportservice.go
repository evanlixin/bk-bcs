...
func (watch *ExportServiceWatch) AddEvent(obj interface{}) {
	...
	if err := watch.report.ReportData(sync); err != nil {
		util.ReportSyncTotal(cluster.DataTypeExpSVR, types.ActionAdd, cluster.SyncFailure)
	} else {
		util.ReportSyncTotal(cluster.DataTypeExpSVR, types.ActionAdd, cluster.SyncSuccess)
	}
}
...
func (watch *ExportServiceWatch) DeleteEvent(obj interface{}) {
	...
	if err := watch.report.ReportData(sync); err != nil {
		util.ReportSyncTotal(cluster.DataTypeExpSVR, types.ActionDelete, cluster.SyncFailure)
	} else {
		util.ReportSyncTotal(cluster.DataTypeExpSVR, types.ActionDelete, cluster.SyncSuccess)
	}
}
...
func (watch *ExportServiceWatch) UpdateEvent(obj interface{}) {
	...
	if err := watch.report.ReportData(sync); err != nil {
		util.ReportSyncTotal(cluster.DataTypeExpSVR, types.ActionUpdate, cluster.SyncFailure)
	} else {
		util.ReportSyncTotal(cluster.DataTypeExpSVR, types.ActionUpdate, cluster.SyncSuccess)
	}
}
