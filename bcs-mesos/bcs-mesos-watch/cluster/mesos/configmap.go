...
func (watch *ConfigMapWatch) AddEvent(obj interface{}) {
	...
	if err := watch.report.ReportData(data); err != nil {
		util.ReportSyncTotal(cluster.DataTypeCfg, types.ActionAdd, cluster.SyncFailure)
	} else {
		util.ReportSyncTotal(cluster.DataTypeCfg, types.ActionAdd, cluster.SyncSuccess)
	}
}
...
func (watch *ConfigMapWatch) DeleteEvent(obj interface{}) {
	...
	if err := watch.report.ReportData(data); err != nil {
		util.ReportSyncTotal(cluster.DataTypeCfg, types.ActionDelete, cluster.SyncFailure)
	} else {
		util.ReportSyncTotal(cluster.DataTypeCfg, types.ActionDelete, cluster.SyncSuccess)
	}
}
...
func (watch *ConfigMapWatch) UpdateEvent(old, cur interface{}) {
	...
	if err := watch.report.ReportData(data); err != nil {
		util.ReportSyncTotal(cluster.DataTypeCfg, types.ActionUpdate, cluster.SyncFailure)
	} else {
		util.ReportSyncTotal(cluster.DataTypeCfg, types.ActionUpdate, cluster.SyncSuccess)
	}
}
